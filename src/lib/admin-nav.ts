...
export const NAV: NavItem[] = [
  ...
  { href: '/admin/ritmi', label: 'Ritmi di lavoro', icon: '🌿', group: 'Sistema', profiles: ['quotidiano', 'rivista', 'newsletter'] },
  { href: '/admin/backup', label: 'Backup', icon: '💾', group: 'Sistema', perm: 'settings.manage', profiles: 'all' },
  { href: '/admin/uscita', label: 'Uscita pulita', icon: '🚪', group: 'Sistema', perm: 'settings.manage', profiles: [] },
