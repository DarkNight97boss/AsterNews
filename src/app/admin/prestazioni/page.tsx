...
export default async function PerformancePage() {
  ...
  return <PerformancePanel runs={runs} settings={{ ...settings, psiApiKey: settings.psiApiKey ? '••••' + settings.psiApiKey.slice(-4) : '' }} hasKey={!!(settings.psiApiKey || process.env.PAGESPEED_API_KEY)} pages={pages} />;
}
