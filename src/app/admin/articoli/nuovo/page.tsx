...
import { getCategories, getMedia, getTags, getUsers, getZones } from '@/lib/queries';
...
export default async function NewArticlePage() {
  ...
  return <ArticleEditor initial={initial} isNew isPublic={false} categories={getCategories()} zones={getZones()} tags={getTags()} users={getUsers()} media={getMedia()} permissions={permissionsOf(me)} />;
}
