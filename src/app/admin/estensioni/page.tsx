...
import { ExtensionRegistry } from '@/components/admin/extension-registry';
...
export default async function ExtensionsPage() {
  ...
  return <><ExtensionsManager extensions={list} enabled={s.enabled} config={s.config} /><ExtensionRegistry enabled={s.enabled} /></>;
}
