...
export default async function StatsPage({ searchParams }: PageProps<'/admin/statistiche'>) {
  ...
  return (
    <>
      ...
      <p style={{ margin: '0 0 16px' }}><Link className="btn btn-outline btn-sm" href="/admin/statistiche/autori">👤 Cruscotto per autore e contenuti in calo →</Link> <Link className="btn btn-outline btn-sm" href="/admin/statistiche/senso">🧭 Metriche di senso →</Link> <Link className="btn btn-outline btn-sm" href="/admin/statistiche/ai">🤖 Quanto ci citano le AI →</Link></p>
