    ...
    <>
        ...
        <div className="home-main">
          {lead && (
            <section className="hero-lead">
              ...
              <Link className="card-img" href={articleUrlWith(lead, cats)} style={{ position: 'relative', display: 'block', aspectRatio: '3 / 2', overflow: 'hidden' }}><SmartImage src={lead.coverImage} alt={lead.title} priority sizes="(max-width: 768px) 100vw, 480px" /></Link>
            </section>
          )}
      ...
      {dossierLead && (
        <section className="band"><div className="container"><div className="band-inner">
          ...
          <Link href={articleUrlWith(dossierLead, cats)} className="band-img"><SmartImage src={dossierLead.coverImage} alt={dossierLead.title} sizes="(max-width: 768px) 100vw, 480px" /></Link>
        </div></div></section>
      )}
